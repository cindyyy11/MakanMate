...
class UserService extends BaseService {
  ...
  Future<UserModel?> getUser(String userId) async {
    try {
      final doc = await BaseService.firestore
          .collection(COLLECTION_NAME)
          .doc(userId)
          .get();
  ...
  Future<void> trackInteraction({
    ...
    try {
      ...
      BaseService.logger.i(
        'Interaction tracked: $userId -> $itemId ($interactionType)',
      );
    } catch (e) {
  ...
  Future<List<UserInteraction>> getItemInteractions(String itemId) async {
    try {
      final query = await BaseService.firestore
          .collection(INTERACTIONS_COLLECTION)
      ...
      BaseService.logger.e('Error getting item interactions: $e');
      return [];
    }
  }
