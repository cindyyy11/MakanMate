...
class AuditLogService {
  ...
  Future<void> logReviewRemoval({
    ...
    await logAction(
      ...
      entityType: 'review',
      entityId: reviewId,
      details: {'from': 'active', 'to': 'removed'},
      reason: reason,
    );
  }
  ...
  Future<void> logConfigChange({
    ...
    await logAction(
      ...
      entityId: configKey,
      details: {'from': oldValue.toString(), 'to': newValue.toString()},
  ...
  Future<void> logFeatureFlagChange({
    ...
    await logAction(
      ...
      entityId: featureId,
      details: {'enabled': enabled, 'rolloutPercentage': rolloutPercentage},
